function Get-ConfigReport {
    ...
    foreach ($srv in $SQLServers) {
        ...
        foreach($script in $scripts) {
            ...
            $result = Invoke-Sqlcmd -ServerInstance "$srv" -Database 'master' -InputFile $script.Fullname -OutputAs DataTables -MaxCharLength 100000
        ...
        foreach ($section in $group) { 
            ...
            $subGroups = $section.Group | Select-Object subheading, comment, datatable | Sort-Object -Property subheading | Group-Object -Property subheading
            ...
            foreach ($subSection in $subGroups) {
                ...
                $dataTables = $subSection.Group | Select-Object comment, datatable
